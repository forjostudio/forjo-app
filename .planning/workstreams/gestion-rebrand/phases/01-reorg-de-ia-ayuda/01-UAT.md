...
result: pass
note: "Confirmado POST-DEPLOY (2026-07-06) por el usuario en gestion.forjo.studio, tras el merge de Fases 1+2 a main. Estaba blocked-on-deploy porque el callback de MP corre en el dominio de NEXT_PUBLIC_APP_URL (prod), no en localhost; una vez deployada la rama, el smoke-test pasó. Cierra el acknowledged gap de 01-VERIFICATION.md."
