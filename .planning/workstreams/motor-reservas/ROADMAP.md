...
- [ ] **Phase 19: El panel** - El dueño asigna servicios a cada franja desde Agenda y la grilla muestra qué se da en cada una sin abrir nada; una franja sin servicios se lee como "cualquiera", no como un estado vacío (6/6 planes ejecutados 2026-08-26 — verificación `human_needed`: 3 items de UAT pendientes, ver `19-UAT.md`)
