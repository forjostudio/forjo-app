...
Plans:
- [ ] 18-01-PLAN.md — Migración 071: tabla puente `time_block_services` (RLS + 4 policies + índice inverso) y la vista acotada `public_time_block_services`, validadas por instalación en local (AGENDA-01)
