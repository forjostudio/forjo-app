...
- [ ] **PUB-03**: La página pública muestra SOLO lo publicado — el dueño guarda un cambio en el editor y la web al aire NO cambia hasta que publica.
...
- [ ] **PUB-07**: Go-live — un negocio que nunca publicó sigue viendo su página de reservas de siempre; al publicar por primera vez, su web a medida la reemplaza.
- [ ] **PUB-08**: Las landings que YA están al aire siguen exactamente igual después de la migración, y su borrador arranca como copia fiel de lo publicado (cero regresión).
