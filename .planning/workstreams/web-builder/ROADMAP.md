...
- [x] 16-02-PLAN.md — `scripts/setup-landing.ts`: lee `landing_draft`, gate estricto `parseLandingConfigForWrite`, aviso de choque, `--publish` opt-in, `--inspect` con las dos columnas (wave 2)
...
- [ ] 17-01-PLAN.md — Retirar el flag de entorno (barrido de las 3 superficies TS) + render condicional editor/upsell (`_web-upsell.tsx`) + ítem "Mi web" en el sidebar (visible a todos los verticales)
...
| 17. Exponer el CMS a clientes reales | v0.18 | 0/2 | Not started | - |
