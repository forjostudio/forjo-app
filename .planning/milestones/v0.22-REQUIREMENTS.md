# Requirements Archive: v0.22 Turnos: alta manual y ventana de reserva
...
- [x] **BOOK-WINDOW-01**: El dueño configura en Ajustes la anticipación máxima con la que se puede
...
- [x] **BOOK-WINDOW-03**: El servidor rechaza una reserva **pública** con fecha fuera de la ventana
...
- [x] **BOOK-NOTIFY-01**: El form "Nuevo turno" existente suma un checkbox **opt-in "avisar al cliente
