...
- ✅ **v0.21 "Rediseño visual del login"** — Phase 9 (shipped 2026-07-18)
...
- [x] **Phase 9: Rediseño visual del login** (1/1 plan, LOGINUI-01/02/03) — completed 2026-07-18
  (retroactivo: specs cerradas + HTML de referencia). `MobileLoginHero` + `(split)/layout` dark/crema
  + `.auth-cream-panel` + `useGoogleSignIn`; sin cambios de lógica; SECURED 5/5.
