# Requirements Archive: v0.19 Cuenta y acceso
...
- [x] **AUTH-01**: Un dueño que olvidó su contraseña puede pedir un link de recuperación desde el
  login, poniendo su email.

- [x] **AUTH-02**: Con ese link, el dueño setea una contraseña nueva y entra a su panel.

### Iniciar sesión con Google (AUTH)

- [x] **AUTH-03**: Una persona puede crear su cuenta e iniciar sesión con Google, sin contraseña.

- [x] **AUTH-04**: Un usuario que entra por Google por primera vez cae en el onboarding y crea su
  negocio, igual que uno de email/contraseña.

- [x] **AUTH-05**: Si el mismo email ya tiene cuenta con contraseña y después entra con Google (o al
...
- [x] **MAIL-01**: El mail de confirmación de cuenta llega en español, con la marca Forjo y desde un
  remitente de Forjo — sin "powered by Supabase".

- [x] **MAIL-02**: El mail de recuperación de contraseña llega con la misma marca y remitente.

### Coherencia del alta (AUTH)

- [x] **AUTH-06**: El registro es honesto sobre la confirmación: lo que el usuario ve (mensaje y a
