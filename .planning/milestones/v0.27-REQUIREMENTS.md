# Requisitos archivados: v0.27 — Cupo unificado por servicio

> Workstream `motor-reservas`, Phases 15-17. Shipped **2026-08-24**.
> **10/10 requisitos completos.** Roadmap archivado: `.planning/milestones/v0.27-ROADMAP.md`.
...
## Cómo se movieron los requisitos durante el milestone

Tres cambiaron de alcance **con el trabajo ya empezado**, y quedó escrito por qué:

- **CUPO-09 se REESCRIBIÓ** (2026-08-16) al alcance que quedaba: la parte funcional —ofrecer los tres
  modos, el cupo en un solo lugar, el piso por modo, el bloqueo por espacio compartido y la copy propia
  del rechazo del gate— **ya estaba en producción**, entregada por el guard de 15-02 y el fix de CR-03
  en la migración 069. Quedó el copy que distingue grupal de simultáneo y los tres defectos del editor.
- **POLISH-08 se AMPLIÓ** (2026-08-20), por decisión del dueño en `discuss-phase`: además del badge de
  modo, la tarjeta gana **edición inline del cupo**. Estaba registrado como todo aparte precisamente
  porque es **capacidad nueva, no presentación** — abre un segundo camino de escritura sobre `services`.
  Se incorporó con el costo a la vista, no de contrabando.
- **POLISH-09 se amplió** (2026-08-16) al descubrir que **no era cosmético**: la grilla leía
  `time_blocks.capacity`, columna que la migración 068 había jubilado, o sea que calculaba "lleno" con
  un número que el motor ignora.
